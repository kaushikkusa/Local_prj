...
//			f.mkdirs();
			File f = new File(Constants.resultsFolder+"/"+Constants.resultsDebugDataFolder, path);
...
//			os.flush();
			bw.write(Constants.propSize+getColumnsCount()+Constants.propSizesDelimeter+getRowsCount()+"\n");
			bw.write(toString());
			bw.flush();
...
//				os.close();
	...
	public void setTransform(WaveletTransform t){
		transform = t;
	}

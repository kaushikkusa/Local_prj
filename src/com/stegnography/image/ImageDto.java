...
public class ImageDto {
	...
	public ImageDto(int[] _rgbs, int _width, int _height) {
		super();
		rgbs = _rgbs;
		width = _width;
		height = _height;
	...
	public ImageDto(float [][] _pixelsR, float [][] _pixelsG, float [][] _pixelsB, int _width, int _height) {
...
//		System.out.println(sb.toString());
	...
	public boolean saveToImageFile(String filename, String ext){
        ...
        File imageFile = new File(Constants.resultsFolder+filename+ext);
        try {
	...
	public static boolean saveDecompImagesToFile(ImageDto[] images, String filename, String ext){
	...
	public ImageDto setFilename(String name){
